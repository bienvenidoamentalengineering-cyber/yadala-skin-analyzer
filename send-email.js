...
const RESEND_API_KEY = 're_XXXXXXX'; // ← pon tu key aquí
...
sendYadalaEmail('tu@email.com', 'RECOVER');

// Para probar las 3 líneas:
// sendYadalaEmail('tu@email.com', 'PREVENT');
// sendYadalaEmail('tu@email.com', 'RECOVER');
// sendYadalaEmail('tu@email.com', 'RECLAIM');
